...
def create_data_summary_plot(df, colours = {'ts':'dodgerblue', 'rug':'crimson', 'histogram':'orange'}):
    """
    ...
    if 'wd' in df_clean.keys():
        df_clean['wd'] = [math.cos(math.radians(x)) for x in df_clean['wd']]
